...
analyzers (Squat, Leg Extension, Wall Push-up, Bodyweight Lunge, Windwheel Toe Touch),
and generate comprehensive rehabilitation session result JSON payloads containing
repetition counts, form scores, range of motion, and detected errors.
"""
...
def process_exercise_data(input_json_path, output_json_path, exercise_type):
    try:
    ...
    for video_filename, frames in video_data.items():
        ...
        final_payload[video_filename] = video_result
