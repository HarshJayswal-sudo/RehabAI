...
const Summary = ({ results, onFinish, onRepeat }) => {
  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '95px 16px 50px', backgroundColor: '#F8F9FA', overflowX: 'hidden' }}>
      ...
      <motion.div 
        style={{ maxWidth: '800px', width: '100%', padding: '36px 20px', backgroundColor: '#FFF', borderRadius: '24px', boxShadow: '0 25px 60px rgba(0,0,0,0.06)', border: '1px solid rgba(100,114,217,0.1)', position: 'relative', zIndex: 1 }}
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: 'rgba(16, 185, 129, 0.1)', padding: '6px 16px', borderRadius: '50px', color: '#059669', fontWeight: 800, fontSize: '12px', marginBottom: '12px' }}>
            <Award size={15} /> SESSION COMPLETED
          </div>
          <h1 style={{ fontSize: 'clamp(24px, 5vw, 36px)', fontWeight: 900, marginBottom: '6px', color: '#111827', letterSpacing: '-0.5px' }}>
        ...
        <div className="responsive-grid-2col" style={{ display: 'grid', gridTemplateColumns: '1.2fr 2fr', gap: '24px', alignItems: 'center', marginBottom: '30px', padding: '20px', backgroundColor: '#F8FAFC', borderRadius: '20px', border: '1px solid #E2E8F0' }}>
          
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            <motion.div 
              style={{ 
                width: '140px', height: '140px', borderRadius: '50%', border: '8px solid var(--accent-color)',
            ...
            >
              <div style={{ fontSize: '42px', fontWeight: 900, lineHeight: 1, color: '#111827' }}>
                {results.formScore}%
              </div>
              <div style={{ fontWeight: 800, fontSize: '10px', letterSpacing: '1.2px', color: 'var(--accent-color)', marginTop: '4px' }}>
                FORM ACCURACY
              </div>
            </motion.div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(110px, 1fr))', gap: '12px' }}>
            <div style={{ backgroundColor: '#FFF', padding: '14px', borderRadius: '14px', border: '1px solid #E2E8F0' }}>
              <div style={{ fontSize: '10px', fontWeight: 800, color: '#64748B', letterSpacing: '0.5px' }}>TOTAL REPS</div>
              <div style={{ fontSize: '24px', fontWeight: 900, color: '#111', marginTop: '2px' }}>{results.rep}</div>
            </div>

            <div style={{ backgroundColor: '#FFF', padding: '14px', borderRadius: '14px', border: '1px solid #E2E8F0' }}>
              <div style={{ fontSize: '10px', fontWeight: 800, color: '#64748B', letterSpacing: '0.5px' }}>L/R SYMMETRY</div>
              <div style={{ fontSize: '24px', fontWeight: 900, color: '#10B981', marginTop: '2px' }}>{results.symmetry}%</div>
            </div>

            <div style={{ backgroundColor: '#FFF', padding: '14px', borderRadius: '14px', border: '1px solid #E2E8F0' }}>
              <div style={{ fontSize: '10px', fontWeight: 800, color: '#64748B', letterSpacing: '0.5px' }}>DURATION</div>
              <div style={{ fontSize: '24px', fontWeight: 900, color: '#111', marginTop: '2px' }}>{results.duration || '02:45'}</div>
            </div>

            <div style={{ backgroundColor: '#FFF', padding: '14px', borderRadius: '14px', border: '1px solid #E2E8F0' }}>
              <div style={{ fontSize: '10px', fontWeight: 800, color: '#64748B', letterSpacing: '0.5px' }}>AVG ROM</div>
              <div style={{ fontSize: '24px', fontWeight: 900, color: 'var(--accent-color)', marginTop: '2px' }}>92%</div>
            </div>
          </div>
        </div>
