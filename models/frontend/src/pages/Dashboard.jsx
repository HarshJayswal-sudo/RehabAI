...
import { Activity, Play, Target, Flame, CalendarCheck, Loader2, ArrowRight, Dumbbell, History, Sparkles } from 'lucide-react';
...
const Dashboard = ({ onStartSession, onSelectExercise, onViewExercises, onViewHistory }) => {
  ...
  const summary = progressData?.summary || { average_score: 94, total_sessions: 24, improvement: 6.3 };
  ...
  return (
    <div style={{ position: 'relative', overflowX: 'hidden', minHeight: '100vh', paddingBottom: '100px', backgroundColor: '#F8F9FA', color: '#111', paddingTop: '130px' }}>
      ...
      >
        {/* Top Greeting Header */}
        <motion.div variants={itemVariants} style={{ marginBottom: '35px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '20px' }}>
          <div>
          ...
          <>
            ...
            <motion.div variants={itemVariants} style={{ marginBottom: '35px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(210px, 1fr))', gap: '16px' }}>
                {EXERCISES.map((ex) => (
                  ...
                  >
                    <img src={ex.image} alt={ex.name} style={{ width: '48px', height: '48px', borderRadius: '12px', objectFit: 'cover' }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '30px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                ...
                {/* AI Daily Routine Recommendation */}
                <motion.div variants={itemVariants} style={{ backgroundColor: '#FFF', borderRadius: '24px', padding: '26px', position: 'relative', boxShadow: '0 10px 30px rgba(100,114,217,0.05)', border: '1px solid rgba(100,114,217,0.05)' }}>
                  ...
                  <p style={{ color: '#64748B', fontSize: '13px', lineHeight: 1.6, marginBottom: '20px' }}>
                    3 sets × 10 reps • Knee flexion and stability focus. Maintain your active streak!
                  </p>
                  <button 
